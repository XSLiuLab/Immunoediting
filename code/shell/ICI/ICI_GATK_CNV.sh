...
perl /public/home/wangshx/wt/software/mskcc-vcf2maf-bbe39fe/vcf2maf.pl --input-vcf /public/home/wangshx/wt/immune_therapy_dataset/Nadeem_Riaz_2017_cell/files/on_vcf/${s}_pass.vcf --output-maf /public/home/wangshx/wt/immune_therapy_dataset/Nadeem_Riaz_2017_cell/cnv/ON/vcf2maf/${s}.maf --inhibit-vep --ref-fasta /public/home/liuxs/biodata/reference/genome/hg38/hg38.fa --tumor-id <tumor> --normal-id <normal> --ncbi-build GRCh38
